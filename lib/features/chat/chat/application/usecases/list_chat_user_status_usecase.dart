...
class ListChatUserStatusUsecase implements BaseUsecase<ChatEntity, Unit>{

  final IChatRepository _chatRepository;
  
  ListChatUserStatusUsecase(this._chatRepository);

  @override
  Future<Either<Failure, ChatEntity>> call(Unit _) async => _chatRepository.getChatStatus();
}