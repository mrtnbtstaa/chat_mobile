...
class FlutterSecureStorageManager {
  ...
  Future<String?> getAccessToken() => flutterSecureStorage.read(key: _accessTokenKey);
  Future<String?> getRefreshToken() => flutterSecureStorage.read(key: _refreshTokenKey);
